...
-- AlterTable
ALTER TABLE "Wedding" ADD COLUMN     "isPublished" BOOLEAN NOT NULL DEFAULT true,
ALTER COLUMN "brideImage" DROP DEFAULT,
ALTER COLUMN "groomImage" DROP DEFAULT,
ALTER COLUMN "qris" DROP DEFAULT,
